...
public class ItemGiantFernRender implements IItemRenderer {

    private ModelGiantFern modelGrinder;

    public ItemGiantFernRender() {
        modelGrinder = new ModelGiantFern();
    }
    ...
    private void renderGrinder(float x, float y, float z) {
    	GuiHelper.bindTexture(ResourceReference.giantFern);
