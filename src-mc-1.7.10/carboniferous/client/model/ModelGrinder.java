  ...
  //fields
    ...
    public ModelGrinder() {
    	...
    	top.setTextureSize(128, 64);
      	...
      	setRotation(centreCog, 0F, 0F, 0F);
    ...
    public void rotateCog(float plus) {
    	...
    	centreStick.rotateAngleY = plus;
    	cog1.rotateAngleY = plus + 1.256637F;
    	cog2.rotateAngleY = plus - 2.513274F;
    	cog3.rotateAngleY = plus - 1.256637F;
