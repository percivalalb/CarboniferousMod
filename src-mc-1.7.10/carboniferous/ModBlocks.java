...
import carboniferous.block.BlockAntHill;
import carboniferous.block.BlockBrittleIce;
import carboniferous.block.BlockCarboniferousSand;
import carboniferous.block.BlockCarboniferousStairs;
import carboniferous.block.BlockCompressor;
import carboniferous.block.BlockCoral;
import carboniferous.block.BlockCustomDoor;
...
import carboniferous.block.BlockLog;
import carboniferous.block.BlockMultipleBlocks;
import carboniferous.block.BlockMultipleBlocks2;
import carboniferous.block.BlockMultipleBlocks3;
import carboniferous.block.BlockPillar;
import carboniferous.block.BlockPlanks;
import carboniferous.block.BlockPlanksSlab;
import carboniferous.block.BlockPortal;
import carboniferous.block.BlockSapling;
import carboniferous.block.BlockTilledDirt;
import carboniferous.block.BlockTimeBox;
import carboniferous.block.BlockVine;
import carboniferous.block.BlockWall;
import carboniferous.block.BlockWallShell;
import carboniferous.block.BlockWaterPlant;
import carboniferous.item.ItemLeaves;
import carboniferous.item.ItemLogs;
import carboniferous.item.ItemMulipleBlock;
import carboniferous.item.ItemPlankSlab;
...
public class ModBlocks {
	...
	public static void init() {
		...
		brittleIce = new BlockBrittleIce().setBlockName("carbon.brittleIce");
		...
		GameRegistry.registerBlock(giantFern, "giant_fern");
		GameRegistry.registerBlock(brittleIce, "brittle_ice");
		//Register Tile Entity
		GameRegistry.registerTileEntity(TileEntityGrinder.class, "carboniferous:grinder");
		GameRegistry.registerTileEntity(TileEntityWallShell.class, "carboniferous:wallGrinder");
		GameRegistry.registerTileEntity(TileEntityTimeBox.class, "carboniferous:timeBox");
		GameRegistry.registerTileEntity(TileEntityCompressor.class, "carboniferous:compressor");
