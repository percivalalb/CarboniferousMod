...
public class WorldGenLimestone extends WorldGeneratorCarboniferous {
    ...
    public WorldGenLimestone(Block par1, int par2)
    {
        this(par1, par2, Blocks.stone);
    }

    public WorldGenLimestone(Block par1, int par2, Block par3)
    {
    	super(false);
    ...
    public WorldGenLimestone(Block block, int meta, int number, Block target)
    {
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int i3 = k1; i3 <= j2; ++i3)
                            {
                                ...
                                Block block = this.getBlockIfChunkExists(par1World, k2, l2, i3);
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && (block != null && block.isReplaceableOreGen(par1World, k2, l2, i3, field_94523_c)))
                                {
                                    this.setBlockandMetadataIfChunkExists(par1World, k2, l2, i3, this.minableBlock, minableBlockMeta);
                                }
                            }
                        }
                    }
