...
public class WorldGenLepidodendron extends WorldGenAbstractTree
{
    /**
    ...
    void genTreeLayer(int par1, int par2, int par3, float par4, byte par5, Block par6)
    {
        ...
        for (aint1[par5] = aint[par5]; j1 <= i1; ++j1)
        {
            ...
            while (k1 <= i1)
            {
                ...
                {
                    aint1[b2] = aint[b2] + k1;
                    Block l1 = WorldGenUtils.getBlock(this.worldObj, aint1[0], aint1[1], aint1[2]);

                    if (l1 != Blocks.air && l1 != ModBlocks.leaves_1)
                    {
                        ++k1;
                    }
                    else
                    {
                    	WorldGenUtils.setBlock(this.worldObj, aint1[0], aint1[1], aint1[2], par6, 0, 2);
                        ++k1;
                    }
                }
            }
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int i1 = par2 + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.genTreeLayer(par1, l, par3, f, (byte)1, ModBlocks.leaves_1);
        }
    }
    ...
    void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, Block par3)
    {
        ...
        if (aint2[b1] != 0)
        {
            ...
            for (int k = aint2[b1] + b4; j != k; j += b4)
            {
                ...
                WorldGenUtils.setBlock(this.worldObj, aint3[0], aint3[1], aint3[2], par3, b5, 2);
            }
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(aint, aint1, ModBlocks.logs_1);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.placeBlockLine(aint, aint2, ModBlocks.logs_1);
            }
        }
    }
    ...
    int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
    {
        ...
        else
        {
            ...
            for (j = aint2[b1] + b4; i != j; i += b4)
            {
                ...
                Block k = WorldGenUtils.getBlock(this.worldObj, aint3[0], aint3[1], aint3[2]);

                if (k != Blocks.air && k != ModBlocks.leaves_1)
                {
                    break;
                }
            }
    ...
    boolean validTreeLocation()
    {
        ...
        Block soil = WorldGenUtils.getBlock(this.worldObj, this.basePos[0], this.basePos[1] - 1, this.basePos[2]);
        ...
        else
        {
        	for (int i1 = 0; i1 < 1; i1++)
            {
                for (int j1 = 0; j1 < 10; j1++)
                {
                    ...
                    {
                    	WorldGenUtils.setBlock(this.worldObj, par3 + i1, par4 + j1, par5 + k1, ModBlocks.logs_1, 0, 2);
                    }
                }
            }
