...
public class BiomeCarboniferous extends Biome {

	public BiomeCarboniferous(BiomeProperties properties) {
		super(properties);
		this.decorator = new BiomeDecoratorCarboniferous();
		this.topBlock = ModBlocks.GRASS.getDefaultState();
		this.fillerBlock = ModBlocks.DIRT.getDefaultState();
