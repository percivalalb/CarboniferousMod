package carboniferous.api.registry;
...
public class ItemList {
	...
	public void registerItem(Item item, int meta) {
		...
		if(this.itemlist.contains(array))
			Carboniferous.LOGGER.warn("The item {} meta {} is already registered in this item list", item, meta);
		else {
			this.itemlist.add(array);
			Carboniferous.LOGGER.info("The item {} meta {} was register to an item list", item, meta);
		}
	}
