...
public class BlockMultipleBlocks extends Block {
	...
	public static Icon cobbleGranite;
	public static Icon brickGranite;
	public static Icon limestone;
	public static Icon limestoneBrick;
	public static Icon sediment;
	public static Icon sedimentFish;
	public static Icon sedimentGold;
	public static Icon sedimentHematite;
	public static Icon sedimentPyrite;
	public static Icon graniteDiamond;
	public static Icon graniteGold;
	public static Icon graniteHematite;
	public static Icon granitePyrite;
	public static Icon oreStoragePyrite;
	
	public BlockMultipleBlocks(int par1) {
