...
public class WorldGenLepidodendron extends WorldGeneratorCarboniferous
{
    /**
    ...
    int heightLimit = 10;
    int height;
    double heightAttenuation = 0.61799999999999999D;
    double branchDensity = 1.0D;
    double branchSlope = 0.38100000000000001D;
    ...
    public WorldGenLepidodendron(boolean par1) {
        super(par1);
    }
    ...
    void genTreeLayer(int par1, int par2, int par3, float par4, byte par5, int par6)
    {
        ...
        for (aint1[par5] = aint[par5]; j1 <= i1; ++j1)
        {
            ...
            while (k1 <= i1)
            {
                ...
                {
                    aint1[b2] = aint[b2] + k1;
                    int l1 = this.getBlockIfChunkExists(worldObj, aint1[0], aint1[1], aint1[2]);

                    if (l1 != 0 && l1 != ModBlocks.leaves_1.blockID)
                    {
                        ++k1;
                    }
                    else
                    {
                        this.setBlockandMetadataIfChunkExists(this.worldObj, aint1[0], aint1[1], aint1[2], par6, 0);
                        ++k1;
                    }
                }
            }
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int i1 = par2 + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.genTreeLayer(par1, l, par3, f, (byte)1, ModBlocks.leaves_1.blockID);
        }
    }
    ...
    void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, int par3)
    {
        ...
        if (aint2[b1] != 0)
        {
            ...
            for (int k = aint2[b1] + b4; j != k; j += b4)
            {
                ...
                this.setBlockandMetadataIfChunkExists(this.worldObj, aint3[0], aint3[1], aint3[2], par3, b5);
            }
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(aint, aint1, ModBlocks.logs_1.blockID);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.placeBlockLine(aint, aint2, ModBlocks.logs_1.blockID);
            }
        }
    }
    ...
    int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
    {
        ...
        else
        {
            ...
            for (j = aint2[b1] + b4; i != j; i += b4)
            {
                ...
                int k = this.getBlockIfChunkExists(worldObj, aint3[0], aint3[1], aint3[2]);

                if (k != 0 && k != ModBlocks.leaves_1.blockID)
                {
                    break;
                }
            }
    ...
    boolean validTreeLocation()
    {
        ...
        int i = this.getBlockIfChunkExists(worldObj, this.basePos[0], this.basePos[1] - 1, this.basePos[2]);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (heightLimit == 10)
        {
            heightLimit = 15 + rand.nextInt(heightLimitLimit);
        }
        ...
        else
        {
        	for (int i1 = 0; i1 < 1; i1++)
            {
                for (int j1 = 0; j1 < 10; j1++)
                {
                    ...
                    {
                    	par1World.setBlock(par3 + i1, par4 + j1, par5 + k1, ModBlocks.logs_1.blockID);
                    }
                }
            }
