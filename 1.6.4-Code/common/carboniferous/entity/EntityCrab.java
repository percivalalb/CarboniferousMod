...
public class EntityCrab extends EntityMob {
    ...
    public void onUpdate() {
    	this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setAttribute(this.entityToAttack != null ? 0.75D : 0.2D);
        super.onUpdate();
    }
    ...
    public boolean getCanSpawnHere() {
         ...
         return super.getCanSpawnHere() && worldObj.getBlockId(var1, var2 - 1, var3) == ModBlocks.grass.blockID;
    }
