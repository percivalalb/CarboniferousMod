...
public class CarboniferousApi {
	...
	//Armor
	public static EnumArmorMaterial armorFlippers = EnumHelper.addArmorMaterial("Flippers", 5, new int[]{1, 1, 1, 1}, 0);
	public static EnumArmorMaterial armorAmphibianSkin = EnumHelper.addArmorMaterial("AmphibianSkin", 5, new int[]{1, 3, 2, 1}, 0);
	public static EnumArmorMaterial armorQuiver = EnumHelper.addArmorMaterial("Quiver", 0, new int[]{0, 0, 0, 0}, 0);
	//Creative Tab
	...
	private static final List<ArrayList<Integer>> sedimentOres = new ArrayList<ArrayList<Integer>>();
	
	public static void addSedimentOre(int blockId, int blockMeta) {
	...
	public static List<ArrayList<Integer>> getSedimentOres() {
		return sedimentOres;
	}
	...
	public static void registerLargeItem(Item item) {
		...
		try {
			MinecraftForgeClient.registerItemRenderer(item.itemID, (IItemRenderer)Class.forName("carboniferous.client.renderer.item.ItemLargeRenderer").newInstance());
		} 
		catch(Exception e) {
			e.printStackTrace();
		}
