...
public class WorldGenWaterCalamites extends WorldGeneratorCarboniferous
{
    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
        if (world.getBlockId(i, j - 1, k) == ModBlocks.dirt.blockID && world.getBlockMaterial(i, j, k) == Material.water && world.isAirBlock(i, j + 4, k) && world.isAirBlock(i, j + 12, k)) {
            for (int l = 0; l < 1; l++)
            {
