...
public class GuiGrinder extends GuiContainer
{
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        String s = this.grinder.isInvNameLocalized() ? this.grinder.getInvName() : StatCollector.translateToLocal(this.grinder.getInvName());
        this.fontRenderer.drawString(s, this.xSize / 2 - this.fontRenderer.getStringWidth(s) / 2 + 20, 6, 4210752);
