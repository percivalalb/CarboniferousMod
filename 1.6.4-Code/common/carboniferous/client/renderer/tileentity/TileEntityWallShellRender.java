...
public class TileEntityWallShellRender extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
		...
		if(shell.getShellID() < 1) return;
		if(Item.itemsList[shell.getShellID()] == null) return;
		GL11.glPushMatrix();
		...
		this.renderItem(Item.itemsList[shell.getShellID()].getIconFromDamage(shell.getShellMetadata()));
		GL11.glPopMatrix();
	}
	
	public void renderItem(Icon icon) {
	    GL11.glPushMatrix();
