...
public class RecipeHandler {
	...
	public static void inti() {
	    ...
	    for(int var1 = 0; var1 < 4; ++var1) {
	    	...
	    	FurnaceRecipes.smelting().addSmelting(ModBlocks.logs_1.blockID, var1, new ItemStack(Item.coal, 1, 1), 0.15F);
	    }
	    FurnaceRecipes.smelting().addSmelting(ModBlocks.multiBlock1.blockID, 1, new ItemStack(ModBlocks.multiBlock1, 1, 0), 0.1F);
	    FurnaceRecipes.smelting().addSmelting(ModItems.multiItems.itemID, 2, new ItemStack(Item.ingotIron.itemID, 1, 0), 0.35F);
	    FurnaceRecipes.smelting().addSmelting(ModItems.rawDragonfly.itemID, 0, new ItemStack(ModItems.cookedDragonfly, 1, 0), 0.35F);
	    FurnaceRecipes.smelting().addSmelting(ModItems.rawAmphibian.itemID, 0, new ItemStack(ModItems.cookedAmphibian, 1, 0), 0.35F);
	    FurnaceRecipes.smelting().addSmelting(ModItems.rawAnt.itemID, 0, new ItemStack(ModItems.cookedAnt), 0.25F);
	    FurnaceRecipes.smelting().addSmelting(ModBlocks.sand.blockID, new ItemStack(ModBlocks.clearGlass), 0.1F);
	    ...
	    CraftingHelper.addShapedRecipe(new ItemStack(ModBlocks.grinder, 1, 0), new Object[] {"BTB", "GSG", "GGG", 'S', Item.stick, 'B', new ItemStack(ModBlocks.multiBlock1, 4, 2), 'G', new ItemStack(ModBlocks.multiBlock1, 1, 0), 'T', new ItemStack(ModItems.multiItems, 1, 9)}); //Grinder
	    CraftingHelper.addShapedRecipe(new ItemStack(ModItems.net, 1, 0), new Object[] {" TT", " ST", "S  ", 'S', Item.stick, 'T', Item.silk}); //Net
	    CraftingHelper.addShapedRecipe(new ItemStack(ModItems.multiItems, 1, 5), new Object[] {" RD", " IR", "I  ", 'R', Item.redstone, 'I', Item.ingotIron, 'D', Item.diamond}); //Timerod
	    CraftingHelper.addShapedRecipe(new ItemStack(ModBlocks.timeBox, 1), new Object[] {"ILI", "RDR", "ILI", 'R', Item.redstone, 'I', Item.ingotIron, 'D', Item.diamond, 'L', Block.blockLapis}); //Timebox
	    ...
	    CraftingHelper.addShapedRecipe(new ItemStack(ModBlocks.multiBlock2, 4, 0), new Object[] {"GBG", "BRB", "GBG", 'B', new ItemStack(ModBlocks.multiBlock1, 1, 2), 'G', Item.glowstone, 'R', Item.redstone}); //Granite Sunstone
	    CraftingHelper.addShapedRecipe(new ItemStack(Item.arrow, 5), new Object[] {"X", "#", "Y", 'Y', new ItemStack(ModItems.multiItems, 2, 12), 'X', Item.flint, '#', Item.stick}); //Arrows
	    CraftingHelper.addShapedRecipe(new ItemStack(Item.arrow, 5), new Object[] {"X", "#", "Y", 'Y', Item.feather, 'X', new ItemStack(ModItems.multiItems, 1, 11), '#', Item.stick}); //Arrows
	    CraftingHelper.addShapedRecipe(new ItemStack(Item.arrow, 6), new Object[] {"X", "#", "Y", 'Y', new ItemStack(ModItems.multiItems, 2, 12), 'X', new ItemStack(ModItems.multiItems, 1, 11), '#', Item.stick}); //Arrows
	    ...
	    CraftingHelper.addShapedRecipe(new ItemStack(ModItems.grindingStones, 1, 1), new Object[] {" B ", "BSB", " B ", 'B', new ItemStack(Item.ingotIron), 'S', new ItemStack(ModItems.grindingStones, 1, 0)}); //Iron Grinding Ball
	    ...
	    CraftingHelper.addShapedRecipe(new ItemStack(ModItems.flippers, 1), new Object[] {"I I", " B ", "A A", 'I', Item.ingotIron, 'B', ModItems.amphibianSkinBoot, 'A', new ItemStack(ModItems.multiItems, 1, 10)}); //Flippers
	    
	    CraftingHelper.addShapedRecipe(new ItemStack(Block.furnaceIdle, 1), new Object[] {"GGG", "G G", "GGG", 'G', new ItemStack(ModBlocks.multiBlock1, 1, 1)}); //Furnace from Granite cobble
	    CraftingHelper.addShapedRecipe(new ItemStack(Block.dispenser, 1), new Object[] {"###", "#X#", "#R#", '#', new ItemStack(ModBlocks.multiBlock1, 1, 1), 'X', Item.bow, 'R', Item.redstone});
	    ...
	    CraftingHelper.addShapedRecipe(new ItemStack(Item.pickaxeStone), new Object[] {"CCC", " S ", " S ", 'C', new ItemStack(ModBlocks.multiBlock1, 1, 1), 'S', Item.stick});
	    CraftingHelper.addShapedRecipe(new ItemStack(Item.axeStone), new Object[] {"CC", "CS", " S", 'C', new ItemStack(ModBlocks.multiBlock1, 1, 1), 'S', Item.stick});
	    CraftingHelper.addShapedRecipe(new ItemStack(Item.shovelStone), new Object[] {"C", "S", "S", 'C', new ItemStack(ModBlocks.multiBlock1, 1, 1), 'S', Item.stick});
	    CraftingHelper.addShapedRecipe(new ItemStack(Item.hoeStone), new Object[] {"CC", " S", " S", 'C', new ItemStack(ModBlocks.multiBlock1, 1, 1), 'S', Item.stick});
	    CraftingHelper.addShapedRecipe(new ItemStack(Item.swordStone), new Object[] {"C", "C", "S", 'C', new ItemStack(ModBlocks.multiBlock1, 1, 1), 'S', Item.stick});
	    ...
	    int var1 = 0;;
	    for(int item : doors) {
	    	CraftingHelper.addShapedRecipe(new ItemStack(ModItems.multiItems, 1, item), new Object[] {"BBS", "BBS", "BBS", 'B', new ItemStack(ModBlocks.planks_1, 1, var1), 'S', Item.stick}); //Doors
	    	CraftingHelper.addShapedRecipe(new ItemStack(ModItems.multiItems, 1, item), new Object[] {"SBB", "SBB", "SBB", 'B', new ItemStack(ModBlocks.planks_1, 1, var1), 'S', Item.stick}); //Doors
	    	++var1;
	    }
		...
		CarboniferousApi.addGrinderRecipe(Block.stoneBrick, null, new ItemStack(Block.stoneBrick, 1, 2));
		...
		CarboniferousApi.addGrinderRecipe(Block.stoneBrick, null, new ItemStack(Block.stone));
		CarboniferousApi.addGrinderRecipe(new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), null, new ItemStack(ModItems.multiItems, 1, 13));
		CarboniferousApi.addGrinderRecipe(ModBlocks.sand, null, new ItemStack(Block.sand));
		CarboniferousApi.addGrinderRecipe(new ItemStack(ModBlocks.coral, 1, 0), null, new ItemStack(Item.dyePowder, 4, 14));
		CarboniferousApi.addGrinderRecipe(new ItemStack(ModBlocks.coral, 1, 1), null, new ItemStack(Item.dyePowder, 4, 11));
		CarboniferousApi.addGrinderRecipe(new ItemStack(ModBlocks.coral, 1, 2), null, new ItemStack(Item.dyePowder, 4, 1));
		CarboniferousApi.addGrinderRecipe(new ItemStack(ModBlocks.coral, 1, 3), null, new ItemStack(Item.dyePowder, 4, 7));
		CarboniferousApi.addGrinderRecipe(new ItemStack(ModBlocks.coral, 1, 4), null, new ItemStack(Item.glowstone, 4));
		CarboniferousApi.addGrinderRecipe(new ItemStack(ModBlocks.multiBlock3, 1, 3), null, new ItemStack(Item.diamond, 1));
