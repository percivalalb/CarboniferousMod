package carboniferous.client.renderer;
 ...
 **/
public class CarboniferousSkyProvider extends IRenderHandler {

	public static final int starGLCallList = GLAllocation.generateDisplayLists(3);
	public static final int glSkyList = starGLCallList + 1;
	public static final int glSkyList2 = starGLCallList + 2;
	
	public static final String moonPhasesTex = "/environment/moon_phases.png";
	public static final String sunTex = "/mods" + Properties.PACKAGE + "/textures/environment/carboniferousSun.png";
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        f10 = 30.0F;
        //TODO mc.renderEngine.bindTexture(sunTex);
        ...
        tessellator1.draw();
        f10 = 20.0F;
        //TODO mc.renderEngine.bindTexture(moonPhasesTex);
