...
public class ItemPlankSlab extends ItemBlock
{
    ...
    public ItemPlankSlab(Block block)
    {
        super(block);
        this.field_150949_c = ModBlocks.woodSingleSlab;
        this.field_150947_d = ModBlocks.woodDoubleSlab;
        this.field_150948_b = ModBlocks.woodDoubleSlab == block ? true : false;
        this.setMaxDamage(0);
